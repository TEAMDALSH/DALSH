...
IP = io.popen("dig +short myip.opendns.com @AUJLJI.opendns.com"):read('*a')
...
io.popen("mkdir DALSH _Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls DALSH _Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevDALSH e(user_id) == true then
var = true
...
elseif tonumber(user_id) == tonumber(665877797) then  
var = "مطور السورس"  
elseif DevDALSH e(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
function DALSH _Files(msg)
for v in io.popen('ls DALSH _Files'):lines() do
if v:match(".lua$") then
plugin = dofile("DALSH _Files/"..v)
...
function DALSH _Started_Bot(msg,data) -- بداية العمل
if msg then
...
local DALSH _Msg = database:sismember(bot_id.."DALSH :List:Filter:text"..msg.chat_id_,text) 
if DALSH _Msg then    
...
local DALSH rt = database:get(bot_id.."DALSH :Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if DALSH rt == "مميز" and Addictive(msg) then
...
database:sadd(bot_id.."DALSH :Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif DALSH rt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/FBBBBB)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "FBBBBB")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."DALSH :Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."DALSH :Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif DALSH rt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/FBBBBB)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "FBBBBB")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."DALSH :Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."DALSH :Manager"..msg.chat_id_,result.sender_user_id_)  
elseif DALSH rt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/FBBBBB)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "FBBBBB")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local DALSH rt = database:get(bot_id.."DALSH :Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if DALSH rt == "مميز" and Addictive(msg) then
...
function Function_DALSH (extra, result, success)
if DevDALSH e(result.sender_user_id_)  then
...
if DevDALSH e(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.sender_user_id_)
database:srem(bot_id.."DALSH :Sudo:User", result.sender_user_id_)
database:srem(bot_id.."DALSH :Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."DALSH :Constructor"..msg.chat_id_, result.sender_user_id_)
...
os.execute('wget https://raw.githubusercontent.com/DALSH /DALSH /master/DALSH .lua')
os.execute('wget https://raw.githubusercontent.com/DALSH /DALSH /master/start.lua')
dofile('DALSH .lua')  
return false
end
if text == "راسلني" then
...
local Check_File_is_Found = io.open("DALSH _Files/"..name,"r")
...
local file_bot = io.open("DALSH _Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
if res == 200 then
os.execute("rm -fr DALSH _Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DALSH .lua')  
else
...
local json_file, res = https.request("https://raw.githubusercontent.com/DALSH /files_DALSH /master/files_DALSH /"..file)
if res == 200 then
local chek = io.open("DALSH _Files/"..file,'w+')
...
send(msg.chat_id_,msg.id_,'⌔︙شترك في قناة السورس اولآ @HlHHT .')   
return false 
end
Text = [[
*- Black Team .*
...
[⌔︙BLacK 𝖲𝗈𝗎𝗋𝖼𝖾  .](https://t.me/HlHHT) .
     
[⌔︙𝘛WSL Source BLacK .](http://t.me/DRAKIALI_BOT) .
...
inline = {
{{text = '⌔︙ BLacK 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='https://t.me/HlHHT'}},
}
...
inline = {
{{text = '⌔︙ BLacK 𝖲𝗈𝗎𝗋𝖼??  .',url='https://t.me/HlHHT'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
...
------------------------------------------------------------------------
if text then
local DALSH _Msg = database:sismember(bot_id.."DALSH :List:Filter:text"..result.chat_id_,text) 
if DALSH _Msg then    
...
>> The Bot is Running
>> Bot source > Black
>>Source channel > @HlHHT
>>Source developer > @TeAm_DALSH
 ____  _        _    ____ _  __
| __ )| |      / \  / ___| |/ /
|  _ \| |     / _ \| |   | ' / 
| |_) | |___ / ___ \ |___| . \ 
...
local list = database:smembers(bot_id..'DRAKIBOT:UsersBot')  
for k,v in pairs(list) do 
